...
#ifdef CAEN_PLU_EXPORTS
#define CAEN_PLU_API extern "C" __declspec(dllexport)
#else
#define CAEN_PLU_API extern "C" __declspec(dllimport)
#endif
#else
#define CAEN_PLU_API
#endif
...
* \ingroup			Core
*/
CAEN_PLU_API CAEN_PLU_ERROR_CODE CAEN_PLU_OpenDevice(t_ConnectionModes connection_mode, char *IPAddress_or_SN_or_VMEBaseAddress, int VMElink, int VMEConetNode, int *handle);
...
* \ingroup			Core
*/
CAEN_PLU_API CAEN_PLU_ERROR_CODE CAEN_PLU_CloseDevice(int handle);
...
* \ingroup			Core
*/
CAEN_PLU_API CAEN_PLU_ERROR_CODE CAEN_PLU_WriteReg(int handle, uint32_t address, uint32_t value);
...
* \ingroup			Core
*/
CAEN_PLU_API CAEN_PLU_ERROR_CODE CAEN_PLU_ReadReg(int handle, uint32_t address, uint32_t *value);
...
* \ingroup		   Core
*/
CAEN_PLU_API CAEN_PLU_ERROR_CODE CAEN_PLU_WriteData32(int handle, uint32_t start_address,  uint32_t size, uint32_t *value);
...
* \ingroup		   Core
*/
CAEN_PLU_API CAEN_PLU_ERROR_CODE CAEN_PLU_WriteFIFO32(int handle, uint32_t start_address, uint32_t size, uint32_t *value);
...
* \ingroup			Core
*/
CAEN_PLU_API CAEN_PLU_ERROR_CODE CAEN_PLU_ReadData32(int handle, uint32_t start_address, uint32_t size, uint32_t *value, uint32_t *nw);
...
* \ingroup			Core
*/
CAEN_PLU_API CAEN_PLU_ERROR_CODE CAEN_PLU_ReadFIFO32(int handle, uint32_t address, uint32_t size, uint32_t *value, uint32_t *nw);
/**@}*/
...
* \ingroup			Enumerate
*/
CAEN_PLU_API CAEN_PLU_ERROR_CODE CAEN_PLU_USBEnumerate(tUSBDevice *pvArg1, uint32_t *numDevs);
...
CAEN_PLU_API CAEN_PLU_ERROR_CODE CAEN_PLU_USBEnumerateSerialNumber(unsigned int *numDevs, char *DeviceSNs, uint32_t buffersize);
...
*/
CAEN_PLU_API CAEN_PLU_ERROR_CODE CAEN_PLU_InitGateAndDelayGenerators(int handle);
...
* \ingroup		   GateAndDelay
*/
CAEN_PLU_API CAEN_PLU_ERROR_CODE CAEN_PLU_SetGateAndDelayGenerator(int handle,  uint32_t channel, uint32_t enable, uint32_t gate, uint32_t delay, uint32_t scale_factor);
...
* \ingroup		   GateAndDelay
*/
CAEN_PLU_API CAEN_PLU_ERROR_CODE CAEN_PLU_SetGateAndDelayGenerators(int handle, uint32_t gate, uint32_t delay, uint32_t scale_factor);
...
* \ingroup		   GateAndDelay
*/
CAEN_PLU_API CAEN_PLU_ERROR_CODE CAEN_PLU_GetGateAndDelayGenerator(int handle, uint32_t channel, uint32_t *gate, uint32_t *delay, uint32_t *scale_factor); // TODO enable status and bypass
/**@}*/
...
* \ingroup		   Flash
*/
CAEN_PLU_API CAEN_PLU_ERROR_CODE CAEN_PLU_EnableFlashAccess(int handle, t_FPGA_V2495 FPGA);
...
* \ingroup		   Flash
*/
CAEN_PLU_API CAEN_PLU_ERROR_CODE CAEN_PLU_DisableFlashAccess(int handle, t_FPGA_V2495 FPGA);
...
* \ingroup		   Flash
*/
CAEN_PLU_API CAEN_PLU_ERROR_CODE CAEN_PLU_DeleteFlashSector(int handle, t_FPGA_V2495 FPGA, uint32_t sector);
...
* \ingroup		   Flash
*/
CAEN_PLU_API CAEN_PLU_ERROR_CODE CAEN_PLU_WriteFlashData(int handle, t_FPGA_V2495 FPGA, uint32_t address, uint32_t *data, uint32_t length);
...
* \ingroup			Flash
*/
CAEN_PLU_API CAEN_PLU_ERROR_CODE CAEN_PLU_ReadFlashData(int handle, t_FPGA_V2495 FPGA, uint32_t address,	uint32_t *data,	uint32_t length);
/**@}*/
...
* \ingroup			Misc
*/
CAEN_PLU_API CAEN_PLU_ERROR_CODE CAEN_PLU_GetInfo(int handle, tBOARDInfo  *HWOPTIONS); 
...
* \ingroup			Misc
*/
CAEN_PLU_API CAEN_PLU_ERROR_CODE CAEN_PLU_GetSerialNumber(int handle, char  *sn, uint32_t buffersize);
/*!
...
* \ingroup			Misc
*/
CAEN_PLU_API CAEN_PLU_ERROR_CODE CAEN_PLU_ConnectionStatus(int handle, int *status);
/**@}*/
